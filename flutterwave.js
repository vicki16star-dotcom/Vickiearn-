(()=>{
  ...
  window.BluePayPayments={initializeDeposit,handleReturnedPayment};
  window.VickiEarnPayments=window.BluePayPayments;
  window.addEventListener('load',handleReturnedPayment);
})();
